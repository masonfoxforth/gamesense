...
local weapon_chams = setmetatable({
    ...
    cham = ui_new_checkbox("VISUALS", "Other ESP", "Weapon chams"),
    label = ui.new_label("VISUALS", "Other ESP", "Weapon color"),
    color = ui_new_color_picker("VISUALS", "Other ESP", "Weapon color", 255, 255, 255, 255),
    texture = ui_new_combobox("VISUALS", "Other ESP", "Weapon materials", getMenuItems(textures)),
    flags = ui_new_multiselect("VISUALS", "Other ESP", "Weapon flags", getMenuItems(material_var_flags)),
